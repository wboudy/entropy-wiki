...
description: Core architectural concepts from Google's Agent Development Kit
---
...
- Treats context as "Compiled View" rather than raw string
- Handle Pattern offloads large artifacts - agents retrieve them only via tool calls, keeping context lean
