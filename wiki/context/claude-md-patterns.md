...
description: Best practices for writing effective CLAUDE.md files
---
...
CLAUDE.md files should be **under 300 lines**, with shorter being preferable. HumanLayer's own root file is less than 60 lines.
...
- Include "Physics" (build commands, test runners) not history
