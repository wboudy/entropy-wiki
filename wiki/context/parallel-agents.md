...
description: Par CLI for managing concurrent development workflows with AI agents
---
...
- CLI for Parallel Worktrees wrapped in tmux
- Enables "Swarm" development - every agent gets isolated filesystem and terminal
- Prevents file lock collisions during parallel execution
